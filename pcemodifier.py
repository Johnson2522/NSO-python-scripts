...
def modify_segment_list_mpls(device_name, segment_list_name, index_id, new_mpls_label):
    try:
...
# Example usage to modify MPLS label
modify_segment_list_mpls('P1', 'SL3', 1, 16001)
modify_segment_list_mpls('P2', 'SL3', 1, 16001)
